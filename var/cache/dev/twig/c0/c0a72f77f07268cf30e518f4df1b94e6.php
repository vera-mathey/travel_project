...
/* user/edit.html.twig */
class __TwigTemplate_c156a0689050c48ebea928d4166d0e06 extends Template
{
    private $source;
    private $macros = [];
...
<div style=\"background-image: linear-gradient(rgba(4, 56, 19, 0.8), rgba(0, 0, 0, 0.4)), url('";
        // line 9
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("images/avatars/" . twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 9, $this->source); })()), "avatar", [], "any", false, false, false, 9))), "html", null, true);
        echo "')\" class=\"col-md-12 mainpagecity d-flex justify-content-center\">
    <h1 class=\"h1-main d-flex justify-content-center\">Bonjour, ";
        // line 10
...
";
    ...
    {
        return array (  118 => 22,  113 => 20,  108 => 18,  97 => 10,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Edition de profil{% endblock %}

{% block body %}

<div class=\"col-md-12\">

<div style=\"background-image: linear-gradient(rgba(4, 56, 19, 0.8), rgba(0, 0, 0, 0.4)), url('{{ asset('images/avatars/' ~ user.avatar) }}')\" class=\"col-md-12 mainpagecity d-flex justify-content-center\">
    <h1 class=\"h1-main d-flex justify-content-center\">Bonjour, {{user.firstname}}</h1>
</div>
<div class=\"container\">
<div class=\"row\">
<div class=\"col-md-2\"></div>
...
{% endblock %}
", "user/edit.html.twig", "C:\\symfony\\travel_project\\templates\\user\\edit.html.twig");
    }
}
